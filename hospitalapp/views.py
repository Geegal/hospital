...
from hospitalapp.models import Member, ImageModel
...
def index(request):
    if request.method == 'POST':
        message = Message(fullname=request.POST['fullname'], email=request.POST['email'],
...
def details2(request):
    ...
    return render(request, 'details2.html', {'details2': details2})
